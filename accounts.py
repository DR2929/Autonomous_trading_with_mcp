...
class Account(BaseModel):
    ...
    def buy_shares(self, symbol: str, quantity: int, rationale: str) -> str:
        ...
        if quantity <= 0:
            raise ValueError(f"Cannot buy {quantity} shares. Quantity must be greater than 0.")
    ...
    def sell_shares(self, symbol: str, quantity: int, rationale: str) -> str:
        ...
        if quantity <= 0:
            raise ValueError(f"Cannot sell {quantity} shares. Quantity must be greater than 0.")
